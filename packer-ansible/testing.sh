...
newman run "postman/postman_collection_test.json" -d "postman/researchers_test.json.json" -r json --reporter-json-export "postman/output_researcher.json" --folder search_researchers
newman_status1=$?
