...
describe("Test search.js module", () => {
    ...
    describe("Test Cineca functions", () => {
        test.each(testCases['search']['getCinecaInfo'])('should return the correct number of reasearcher and the correct information for %s',
        ...
        test.each(testCases['search']['getByNameCinecaInfoFromDB-writeCinecaInfoToDB'])('should return the correct number of reasearcher and the correct information from DB %s',
            async ({ id, desc, name, surname, expectedResult}) => {
        ...
        test.each(testCases['search']['getByIDCinecaInfoFromDB'])('should return the correct number of reasearcher and the correct information from DB %s',
            async ({ id, desc, expectedResult}) => {
    ...
    describe("Test Scholar functions", () => {
        test.each(testCases['search']['getScholarInfo'])('should return the correct number of reasearcher and the correct information for %s', 
            async ({ id, desc, researcherAteneo, researcherSurname, researcherName, expectedResult}) => {
                console.log(`${id}: ${desc}`);
        ...
        test.each(testCases['search']['getByIDScholarInfoFromDB-writeScholarInfoToDB'])('should return the correct number of reasearcher and the correct information from DB %s', 
            async ({ id, desc, cinecaInfo, expectedResult}) => {
                console.log(`${id}: ${desc}`);
    ...
    describe.skip("Test Scopus functions", () => {
        test.skip.each(testCases['search']['getScopusInfo'])('should return the correct number of reasearcher and the correct information for %s', 
            async ({ id, desc, name, surname, affiliation, expectedResult}) => {
        ...
        test.each(testCases['search']['getByIDScopusInfoFromDB-writeScopusInfoToDB'])('should return the correct number of reasearcher and the correct information from DB %s', 
            async ({ id, desc, cinecaInfo, expectedResult}) => {
